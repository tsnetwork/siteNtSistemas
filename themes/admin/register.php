...
<section class="content">
    <div class="box box-primary">
        <!-- form start -->
        <form action="<?=url('admin/usuarios/novo')?>" method="post" enctype="multipart/form-data">
            ...
            <div class="box-body">
                <div class="form-group">
                    <div class="user-image-div">
                        ...
                        <img src="<?=image('images/defaults/user_icon.png', 100, 100)?>" id="form_image" class="img-circle user-image">
                    </div>
                </div>
                <div class="form-group">
